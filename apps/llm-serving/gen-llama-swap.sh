...
# Space-padded list of dir names to skip entirely, e.g. " comfyui docling ". Empty by default — this module
...
# reload (and evict the resident model!) every cycle. Idempotent: no change => no reload (B5/B6/B13).
